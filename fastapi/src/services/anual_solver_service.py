...
from opts.schema_extractor import get_course_details, get_course_list, get_curriculums, get_day_list, get_homeroom_list, get_instructor_list, get_period_list, get_periods
...
class AnualSolverService:
    ...
    def __init__(self,
        ...
        execute(model, constraint_schemas)
